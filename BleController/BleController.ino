...
void cent_connect_callback(uint16_t conn_handle)
{
  ...
  {
    Serial.println ("Enabling notify on client?");
    // Enable TXD's notify
    clientUart.enableTXD();
    Serial.println("printing " + adv_str);
    bleuart.print(adv_str);
    clientUart.print(adv_str);
  }else
  {
